...
class HER2ST(torch.utils.data.Dataset):
    ...
    def __init__(self,train=True,gene_list=None,ds=None,fold=0):
        ...
        # np.save('../../dataset/her2st_data/her_hvg',self.gene_set)
        # quit()
...
class ViT_HER2ST(torch.utils.data.Dataset):
    ...
    def __init__(self, train=True, fold=0, r=4, flatten=True, ori=False, adj=False, prune='Grid', neighs=4):
        ...
        if train:
            ...
            print(f'train length: {len(tr_names)}')
        else:
            self.names = te_names
            print(f'test: {te_names}')
...
class ViT_HER2ST_HisToGene(torch.utils.data.Dataset):
    """Some Information about HER2ST"""
    def __init__(self,train=True,gene_list=None,ds=None,sr=False,fold=0):
        super(ViT_HER2ST_HisToGene, self).__init__()
...
class ViT_SKIN(torch.utils.data.Dataset):
    ...
    def __init__(self,train=True,gene_list=None,ds=None,sr=False,aug=False,norm=False,fold=0):
        ...
        # gene_list = list(np.load('../../dataset/her2st_data/skin_hvg.npy',allow_pickle=True))
...
if __name__ == '__main__':
    ...
    # np.save('../../dataset/her2st_data/her_g_list.npy',dataset.gene_set)