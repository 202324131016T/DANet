...
def preprocess(adata, n_keep=1000, include=LYM, g=True):
    ...
    if g:
        ...
        #     b = pickle.load(fp)
        b = list(np.load('../../dataset/her2st_data/skin_a.npy',allow_pickle=True))
        adata = adata[:,b]
    elif include:
        # b = adata.copy()
...
def build_adata(name='H1'):
    cnt_dir = '../../dataset/her2st_data/her2st/data/ST-cnts'
    img_dir = '../../dataset/her2st_data/her2st/data/ST-imgs'
    pos_dir = '../../dataset/her2st_data/her2st/data/ST-spotfiles'
    ...
    gene_list = list(np.load('../../dataset/her2st_data/her_g_list.npy'))
